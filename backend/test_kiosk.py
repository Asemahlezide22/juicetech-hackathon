...
check("deposit shown", "R500" in period)
check("one hour total is R650", "R650" in period)
check("two hour total is R750", "R750" in period)
...
check("deposit shown", "R500" in pay)
check("total shown", "R750" in pay)
...
check("deposit", "R500" in receipt)
check("total", "R750" in receipt)
